                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    @foreach($subscriptionPayments as $subscriptionPayment)
                                        <tr class="gradeX">
                                            <td>{{$subscriptionPayment->subscription->institution}}</td>
                                            <td>{{$subscriptionPayment->amount}}</td>
                                            <td>{{$subscriptionPayment->user->name}}</td>
                                            <td>{{ $subscriptionPayment->created_at->format('d/m/Y H:i') }}</td>
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    @can('admin view user')
                                                        <a href="{{ route('admin.user.show', encrypt($subscriptionPayment->user->id)) }}" class="btn-white btn btn-xs">View</a>
                                                    @endcan
                                                </div>
                                            </td>
                                        </tr>
