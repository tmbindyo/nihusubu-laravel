            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.contact.update',$contact->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
                                                                ...
                                                                <td class="text-right">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        @if($loan->status_id == "b810f2f1-91c2-4fc9-b8e1-acc068caa03a")
                                                                            <a href="{{ route('personal.loan.restore', $loan->id) }}" class="btn-warning btn btn-xs">Restore</a>
                                                                        @else
                                                                            <a href="{{ route('personal.loan.delete', $loan->id) }}" class="btn-danger btn btn-xs">Delete</a>
                                                                        @endif
                                                                    </div>
                                                                </td>
                                                            </tr>
...
@include('personal.layouts.modals.contact_to_do')
