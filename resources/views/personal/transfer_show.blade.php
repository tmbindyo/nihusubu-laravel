    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-5">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.transfers')}}">Transfers</a>
                </li>
                <li class="active">
        ...
        <div class="col-md-7">
            <div class="title-action">
                <a href="{{route('personal.transfer.expense.create',$transfer->id)}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Expense </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form method="post" action="{{ route('personal.transfer.update',$transfer->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                @csrf
...
@include('personal.layouts.modals.transfer_to_do')
