...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-9">
        <div class="title-action">
            <a href="{{route('personal.sacco.contributions',1)}}" class="btn btn-primary btn-outline"><i class="fa fa-money"></i> Contributions </a>
            <a href="{{route('personal.sacco.members',1)}}" class="btn btn-primary btn-outline"><i class="fa fa-users"></i> Members </a>
            <a href="{{route('personal.sacco.loans',1)}}" class="btn btn-primary btn-outline"><i class="fa fa-calculator"></i> Loans </a>
            <a href="{{route('personal.sacco.reconciliations',1)}}" class="btn btn-primary btn-outline"><i class="fa fa-pencil"></i> Reconciliations </a>
        </div>
    </div>
</div>
