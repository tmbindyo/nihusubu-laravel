...
@section('title', ' Cash Flow Breakdown')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{route('personal.analysis')}}">Cash Flow</a>
                </li>
                <li class="active">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="{{route('personal.bill.show',1)}}" class="btn-primary btn-outline btn btn-xs">View</a>
                                        <a href="{{route('personal.bill.edit',1)}}" class="btn-warning btn-outline btn btn-xs">Edit</a>
                                        <a href="{{route('personal.bill.delete',1)}}" class="btn-danger btn-outline btn btn-xs">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
