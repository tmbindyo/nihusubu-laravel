    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-5">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                   <a href="{{route('personal.chama.accounts',$chama->id)}}"><strong>Chama Accounts</strong></a>
                </li>
                <li class="active">
                    <strong>Chama Account</strong>
                </li>
            </ol>
        </div>
        <div class="col-md-7">
            ...
            <div class="col-lg-9">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Chama Account <small>edit</small></h5>
