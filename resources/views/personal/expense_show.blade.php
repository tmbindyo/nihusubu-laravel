    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4">
            <div class="title-action">
                <a href="{{route('personal.expense.edit',$expense->id)}}" class="btn btn-warning btn-outline"><i class="fa fa-pencil"></i> Edit </a>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="m-b-md">
                                        ...
                                        <a href="{{route('personal.transaction.create',$expense->id)}}" class="pull-right btn btn-primary btn-outline">Make Payment</a>
                                    </div>
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover dataTables-example" >
                                                            ...
                                                            @foreach($pendingPayments as $transaction)
                                                                <tr class="gradeA">
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                                <a href="{{ route('personal.transaction.pending.payment', $transaction->id) }}" class="btn-warning btn btn-xs">Mark Paid</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            @endforeach
