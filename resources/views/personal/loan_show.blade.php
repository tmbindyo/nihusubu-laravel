    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-7">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.loans')}}">Loan's</a>
                </li>
                <li class="active">
                    <strong>Loan</strong>
                </li>
        ...
        <div class="col-md-5">
            <div class="title-action">
                <a href="{{route('personal.account.show',$loan->account_id)}}" class="btn btn-primary btn-outline"><i class="fa fa-eye"></i> Account </a>
                <a href="{{route('personal.contact.show',$loan->contact_id)}}" class="btn btn-primary btn-outline"><i class="fa fa-eye"></i> Contact </a>
                <a href="{{route('personal.loan.payment.create',$loan->id)}}" class="btn btn-success btn-outline"><i class="fa fa-plus"></i> Payment </a>
            </div>
        </div>
    </div>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <form method="post" action="{{ route('personal.loan.update',$loan->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
...
@include('personal.layouts.modals.loan_to_do')
