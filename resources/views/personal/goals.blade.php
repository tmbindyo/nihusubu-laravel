                    ...
                    <div class="ibox-content">
                        ...
                        <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-group">
                                        <a href="{{route('personal.goal.show',1)}}" class="btn-primary btn-outline btn btn-xs">View</a>
                                        <a href="{{route('personal.goal.edit',1)}}" class="btn-warning btn-outline btn btn-xs">Edit</a>
                                        <a href="{{route('personal.goal.delete',1)}}" class="btn-danger btn-outline btn btn-xs">Delete</a>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
