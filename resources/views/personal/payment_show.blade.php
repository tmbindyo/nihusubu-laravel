    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-5">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('personal.payments')}}">Accounts</a>
                </li>
                <li class="active">
        ...
        <div class="col-md-7">
            <div class="title-action">
                <a href="{{route('personal.payment.refund.create',$payment->id)}}" class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Refund </a>
            </div>
        </div>
    </div>
                                                    ...
                                                    <tbody>
                                                        @foreach($payment->refunds as $refund)
                                                            <tr class="gradeX">
                                                                ...
                                                                <td class="text-right">
                                                                    <div class="btn-group">
                                                                        <a href="{{ route('personal.refund.show', $refund->id) }}" class="btn-white btn btn-xs">View</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        @endforeach
...
@include('personal.layouts.modals.payment_to_do')
